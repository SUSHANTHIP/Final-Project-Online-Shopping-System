          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="#">  <img src="<c:url value="/resources/images/logo4.png"/>" alt="logo" class="logo" >     </a></li>
                <li class=""><a href="#">CG Online Shop</a></li>
					 ...
					 <!-- <li><a href="?lang=en">English</a></li> 
					   ...
					   <c:if test="${pageContext.request.userPrincipal.name!=null}">
					    ...
					    <c:if test="${pageContext.request.userPrincipal.name == null}">
					           ...
					           <li> <a href="<c:url  value="/register"/>"><spring:message code="register.page"/></a>   </li>
					      </c:if>
