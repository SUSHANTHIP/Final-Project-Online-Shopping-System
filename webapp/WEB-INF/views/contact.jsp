	       ...
	       <form name="loginForm"  action="<c:url value="/contact" />"   method="post"  class="form-horizontal"  >
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="form_message" name="message" class="form-control" placeholder="Message for CG online shop *" rows="4" required="required" data-error="Please,leave us a message."></textarea>
            ...
            <div class="col-md-12">
			   ...
			   <c:if test="${pageContext.request.userPrincipal.name != null}">
				...
				<input style="background-color:blue" type="submit" class="btn btn-success btn-send" value="Send message">	           
			   </c:if>
